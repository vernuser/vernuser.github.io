...
[以太网_百度百科 (baidu.com)](https://baike.baidu.com/item/以太网/99684)

FE--快速以太网

[标准以太网、快速以太网、千兆以太网和万兆以太网分别是什么？ - 知乎 (zhihu.com)](https://zhuanlan.zhihu.com/p/139707963)
...
![img](https://imgconvert.csdnimg.cn/aHR0cHM6Ly9pbWFnZXMyMDE1LmNuYmxvZ3MuY29tL2Jsb2cvMzgyMTA4LzIwMTYwNC8zODIxMDgtMjAxNjA0MDkxNjQ5MDMxNDAtOTQ5NTcyMDA3LnBuZw?x-oss-process=image/format,png)
...
![img](https://pic1.zhimg.com/80/v2-82deb4be7068ec65b3ab251df22d5130_720w.webp)

##### 桥接

桥接就是使用物理机的MAC地址，但是是有自己的独立IP的

![在这里插入图片描述](https://img-blog.csdnimg.cn/20201216200700237.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3FxXzQ3MzU0ODI2,size_16,color_FFFFFF,t_70#pic_center)
...
[“桥接”和“NAT”方式区别 - 知乎 (zhihu.com)](https://zhuanlan.zhihu.com/p/65103100)

[VMware虚拟机三种网络模式详解--Bridged（桥接模式）_vm桥接模式是什么意思-CSDN博客](https://blog.csdn.net/qq_47354826/article/details/111301616)
...
[![piJSUE9.png](https://z1.ax1x.com/2023/11/13/piJSUE9.png)](https://imgse.com/i/piJSUE9)
...
[![piJS6De.png](https://z1.ax1x.com/2023/11/13/piJS6De.png)](https://imgse.com/i/piJS6De)

- 利用ZoomEye进行相关搜索

[![piJS48P.png](https://z1.ax1x.com/2023/11/13/piJS48P.png)](https://imgse.com/i/piJS48P)
...
![这里写图片描述](https://img-blog.csdn.net/20171215000304120?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQvdTAxMjI0NjQ1NQ==/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/SouthEast)

协议是**水平的**，即两个协议是**控制两个对等的实体**进行通信的规则。

服务是**垂直的**，即服务是**从下通过层间接口向上**进行提供的

###

[![piUdJeA.png](https://z1.ax1x.com/2023/11/20/piUdJeA.png)](https://imgse.com/i/piUdJeA)

传输层中以端口做区分，也可以叫做是传输层的地址

域名也被看做是一个地址

[![piUdtot.png](https://z1.ax1x.com/2023/11/20/piUdtot.png)](https://imgse.com/i/piUdtot)

MAC地址不可更改！！！

### 路由器

[![piUdUFP.png](https://z1.ax1x.com/2023/11/20/piUdUFP.png)](https://imgse.com/i/piUdUFP)
...
![img](https://bkimg.cdn.bcebos.com/pic/0dd7912397dda144da48b24db8b7d0a20df48688?x-bce-process=image/watermark,image_d2F0ZXIvYmFpa2U5Mg==,g_7,xp_5,yp_5/format,f_auto)
...
GPON：[EPON与GPON的应用与区别 - 知乎 (zhihu.com)](https://zhuanlan.zhihu.com/p/80270214)
...
[![piU6PKK.png](https://z1.ax1x.com/2023/11/20/piU6PKK.png)](https://imgse.com/i/piU6PKK)

ip.src==你手机的ip，因为传文件是TCP协议，随便抓一个追踪流就行，记得改成原始数据

[![piU6FbD.png](https://z1.ax1x.com/2023/11/20/piU6FbD.png)](https://imgse.com/i/piU6FbD)

打不开，用010或者winhex删除前面的一大串就可

[![piU6AVe.png](https://z1.ax1x.com/2023/11/20/piU6AVe.png)](https://imgse.com/i/piU6AVe)
...
- 增加[网络安全](https://cloud.tencent.com/product/ns?from_column=20065&from=20065)性，防止来自外部网络的攻击。
- 控制流量分配，以提高网络带宽效率。
- 允许内部计算机访问外部资源。
...
[![picEaNT.png](https://z1.ax1x.com/2023/12/06/picEaNT.png)](https://imgse.com/i/picEaNT)
...
[BOOTP协议与DHCP协议 - 简书 (jianshu.com)](https://www.jianshu.com/p/f013acd35898)
...
[CIDR地址块及其子网划分（内含原始IP地址分类及其子网划分的介绍）_cidr块-CSDN博客](https://blog.csdn.net/dan15188387481/article/details/49873923)
...
[![picZDmR.png](https://z1.ax1x.com/2023/12/06/picZDmR.png)](https://imgse.com/i/picZDmR)
[![picZw6J.png](https://z1.ax1x.com/2023/12/06/picZw6J.png)](https://imgse.com/i/picZw6J)



信息封装过程：

[![picZ0X9.png](https://z1.ax1x.com/2023/12/06/picZ0X9.png)](https://imgse.com/i/picZ0X9)
